...
final class TranscriptionQueueControllerTests: XCTestCase {
    func testQueueTranscribesPendingEntryAndPersistsVersion() async throws {
        ...
        let provider = MockTranscriptionProvider(
            result: TranscriptionResult(
                text: "hello from transcriptor queue",
                preview: "hello from transcriptor queue",
                characterCount: 22,
                language: "en",
                modelID: "whisper-tiny",
                modelName: "Tiny",
        ...
        XCTAssertEqual(persisted.transcriptText, "hello from transcriptor queue")
    ...
    private func makeController(
        ...
        let controller = TranscriptionQueueController(providers: [provider])
