...
public struct SottoTranscriptionJob: Identifiable, Equatable, Sendable {
    public let id: UUID
...
public typealias TranscriptionJob = SottoTranscriptionJob

public enum SottoTranscriptionStage: String, Codable, Equatable, Sendable {
    case preparingAudio
    case loadingModel
    case transcribing
    case finalizing
...
public struct SottoTranscriptionProgress: Equatable, Sendable {
    public var stage: SottoTranscriptionStage
    public var fractionCompleted: Double?
    public var partialText: String
    public var statusMessage: String

    public init(
        stage: SottoTranscriptionStage,
...
public typealias TranscriptionProgress = SottoTranscriptionProgress

public struct SottoTranscriptionResult: Equatable, Sendable {
...
public typealias TranscriptionResult = SottoTranscriptionResult

public enum SottoTranscriptionError: Error, LocalizedError, Equatable, Sendable {
...
public typealias TranscriptionError = SottoTranscriptionError
