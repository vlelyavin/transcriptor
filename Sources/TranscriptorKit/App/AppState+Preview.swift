...
extension AppState {
    public static var preview: AppState {
        let defaults = UserDefaults(suiteName: "TranscriptorPreviewDefaults") ?? .standard
        defaults.removePersistentDomain(forName: "TranscriptorPreviewDefaults")
        let storageLayout = AppStorageLayout(
            fileManager: .default,
            applicationSupportURLProvider: { FileManager.default.temporaryDirectory.appendingPathComponent("TranscriptorPreview", isDirectory: true) }
        )
